...
# 	ques = models.OneToOneField(Question, on_delete=models.SET_NULL, null = True, blank=True)
...
"""
class Staff(models.Model):
	staff ko details fields

	name = models.CharField(max_length=100)
	position= models.CharField(max_length=100)
	post = models.CharField(max_length =100)
	address = models.CharField(max_length = 100)
	per_nonper= models.CharField(max_length=20, choices= per_nonper_choices)
	ph_num= models.CharField(max_length = 20)
	photo=models.FileField(blank=True, upload_to = 'pis')
	document=models.FileField(blank=True, upload_to = 'pis')
	dob = models.DateField(default= timezone.now)


		# default= timezone.now) blank=True, null=True, auto_now_add= False, default =1
	...
	# appointment = models.ForeignKey(Appointment, on_delete=models.CASCADE, default= "abcd")
